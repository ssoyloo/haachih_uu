  ...
  if (!codeExecuted) {
    ...
    const plansData = [
      {
        title: "Топ 1",
        image:
          "https://www.selenatravel.com/upload/media/default/0001/01/thumb_856_default_big.jpeg",
        evaluation: 85,
        tag: "Орой яахын",
    ...
    plansData.forEach((plan) => {
      ...
      article.innerHTML = `
        ...
        <h3>${plan.title}</h3>
        <meter value="${plan.evaluation / 100}" min="0.0" max="1.0">${
        plan.evaluation
      }%</meter>
